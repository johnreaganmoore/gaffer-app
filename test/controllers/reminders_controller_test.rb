...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post reminders_url, params: { reminder: { interval: @reminder.interval, label: @reminder.label, next_date: @reminder.next_date, references: @reminder.references } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { interval: @reminder.interval, label: @reminder.label, next_date: @reminder.next_date, references: @reminder.references } }
